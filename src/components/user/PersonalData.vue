    ...
    <v-row align="center" justify="center">
      <v-col cols="6">
        ...
        <div class="my-5" v-else>
          <div class="mb-1">Full Name: <span class="float-right">{{ fullName }}</span></div>
        ...
        <div class="mt-10" v-else>
          <div class="mb-1">E-mail: <span class="float-right">{{ email }}</span></div>
        ...
        ></v-text-field>
        <div class="mt-10" v-else>
          <div class="mb-1">Phone Number: <span class="float-right">{{ phoneNumber }}</span></div>
          <v-divider class="grey lighten-1 mb-3"></v-divider>
        </div>
        ...
        <div class="mt-10" v-else>
          <div class="mb-1">Date of Birth: <span class="float-right">{{ dateOfBirth }}</span></div>
          <v-divider class="grey lighten-1 mb-3"></v-divider>
        </div>
        <v-select
            v-if="editMode"
            ...
            :rules="genderRules"
            required
            :items="[{value: 'MALE', gender: 'Male'}, {value: 'FEMALE', gender: 'Female'}, {value: 'OTHER', gender: 'Other'}]"
            item-text="gender"
            item-value="value"
            label="Select gender"
        ></v-select>
        <div class="mt-10" v-else>
          <div class="mb-1">Gender: <span class="float-right">{{ capitalize(gender) }}</span></div>
          <v-divider class="grey lighten-1 mb-3"></v-divider>
        </div>
        <v-text-field
            v-if="editMode"
        ...
        ></v-text-field>
        <div class="mt-10" v-else>
          <div class="mb-1">Website URL: <span class="float-right">{{ website }}</span></div>
          <v-divider class="grey lighten-1 mb-3"></v-divider>
        </div>
        <v-textarea
